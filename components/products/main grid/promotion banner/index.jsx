  ...
  return (
    <div className='bg-[var(--shreeji-primary)] py-10 flex flex-col md:flex-row items-center gap-10 px-5 md:px-10'>
      {promoProduct.images.length > 1 ? 
        (<Image src={promoProduct.images[1]} alt={promoProduct.name} className="hidden md:flex h-auto w-[40%] object-cover scale-x-[-1] product-shadow" />) :
      ...
      <div className='flex-1 md:w-[60%] flex flex-col gap-3'>
        ...
        {promoProduct.images.length > 1 ? 
          (<Image src={promoProduct.images[1]} alt={promoProduct.name} className="flex md:hidden h-auto w-full object-cover scale-x-[-1] product-shadow" />) :
