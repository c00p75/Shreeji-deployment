...
const SkyliftSolutions = () => {
  return (
    <section className="skylift-solutions-section flex-center text-[#171717] py-20 px-10 overflow-visible">
      <div className="flex w-full gap-10 relative">
        <div className="flex items-center w-[40%] overflow-visible" />

        <Image
          src={skylift}
          alt="SHreeji"
          quality={100}
          className="absolute z-[0] rounded-2xl w-auto grayscale h-[123vh] object-cover mt-[-16rem]"
        />

        <div className="w-[60%] flex flex-col gap-5 mt-10 relative">
